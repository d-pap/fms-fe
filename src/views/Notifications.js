  ...
  const notify = (place) => {
    ...
    options = {
      ...
      message: (
        <div>
          <div>
            Welcome to <b>Paper Dashboard React</b> - a beautiful freebie for every web developer.
          </div>
        </div>
      ),
      type: type,
            ...
            <Card>
              <CardHeader>
                ...
                <p className="card-category">
                  ...
                  <a target="_blank" href="https://www.instagram.com/manu.nazare/">
                    Nazare Emanuel-Ioan (Manu)
                  </a>
                  . Please checkout the{" "}
                  <a href="https://github.com/creativetimofficial/react-notification-alert" target="_blank">
                    full documentation.
                  </a>
                </p>
              </CardHeader>
                      ...
                      <CardBody>
                        ...
                        <UncontrolledAlert className="alert-with-icon" color="info" fade={false}>
                          ...
                          <span data-notify="message">
                            ...
                            icon and the close button are always vertically aligned. This is a beautiful notification.
                    ...
                    <Card className="card-plain">
                      ...
                      <CardBody>
                        <UncontrolledAlert color="primary" fade={false}>
                          <span>
                            <b>Primary - </b>
                            This is a regular notification made with color="primary"
                          </span>
                        </UncontrolledAlert>
                        <UncontrolledAlert color="info" fade={false}>
                          <span>
                        ...
                        <UncontrolledAlert color="danger" fade={false}>
                          <span>
                            <b>Danger - </b>
                            This is a regular notification made with color="danger"
                          </span>
                        </UncontrolledAlert>
                      </CardBody>
                    </Card>
